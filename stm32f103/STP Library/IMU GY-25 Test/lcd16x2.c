...
void lcd20x4_putc(const char c)
{
	...
	else
	{
		...
		else if (pos > (lcd20x4_START_LINE_1 + 40)&& wow==2)
			lcd20x4_write(lcd20x4_SET_DDRAM_ADDRESS |
...
/*#if lcd20x4_LINES == 1
		...
		if (pos == (lcd20x4_START_LINE_2+20))
			lcd20x4_write(lcd20x4_SET_DDRAM_ADDRESS |
				lcd20x4_START_LINE_2, 0);
		else if (pos == (lcd20x4_START_LINE_1 + 41))
			lcd20x4_write(lcd20x4_SET_DDRAM_ADDRESS |
				lcd20x4_START_LINE_1+41, 0);
		
		else if (pos == (0x00 + 20 + 20))
			lcd20x4_write(lcd20x4_SET_DDRAM_ADDRESS |
				lcd20x4_START_LINE_2+21, 0);
		
		else if (pos == (lcd20x4_START_LINE_2 + 20 + 20))
			lcd20x4_write(lcd20x4_SET_DDRAM_ADDRESS |
				lcd20x4_START_LINE_1, 0);
