...
#define UC_MEMORY_H
	...
	extern uint16_t FEE_Init(void);
	extern void FEE_Erase (void);
	extern uint16_t FEE_WriteDataByte (uint16_t Address, uint8_t DataByte);
	extern uint8_t FEE_ReadDataByte (uint16_t Address);
